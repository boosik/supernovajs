...
export const DistributionProportions = {
  encode(message: DistributionProportions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lpIncentives !== "") {
      writer.uint32(18).string(message.lpIncentives);
    }

    if (message.stableGuaranteeIncentives !== "") {
      writer.uint32(26).string(message.stableGuaranteeIncentives);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DistributionProportions {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.lpIncentives = reader.string();
          break;

        case 3:
          message.stableGuaranteeIncentives = reader.string();
          break;
  ...
  fromJSON(object: any): DistributionProportions {
    return {
      ...
      lpIncentives: isSet(object.lpIncentives) ? String(object.lpIncentives) : "",
      stableGuaranteeIncentives: isSet(object.stableGuaranteeIncentives) ? String(object.stableGuaranteeIncentives) : "",
  ...
  toJSON(message: DistributionProportions): unknown {
    ...
    message.lpIncentives !== undefined && (obj.lpIncentives = message.lpIncentives);
    message.stableGuaranteeIncentives !== undefined && (obj.stableGuaranteeIncentives = message.stableGuaranteeIncentives);
  ...
  fromPartial(object: DeepPartial<DistributionProportions>): DistributionProportions {
    ...
    message.stableGuaranteeIncentives = object.stableGuaranteeIncentives ?? "";
