...
export const createRPCQueryClient = async ({
  ...
  nova: {
    gal: {
      v1: new (await import("./gal/v1/query.rpc.query")).QueryClientImpl(rpc)
    },
    ibcstaking: {
      v1: new (await import("./ibcstaking/v1/query.rpc.query")).QueryClientImpl(rpc)
    },
    mint: {
      v1: new (await import("./mint/v1/query.rpc.query")).QueryClientImpl(rpc)
    },
    oracle: {
