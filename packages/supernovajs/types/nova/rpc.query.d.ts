...
export declare const createRPCQueryClient: ({ rpc }: {
    ...
    nova: {
        gal: {
            v1: import("./gal/v1/query.rpc.query").QueryClientImpl;
        };
        ibcstaking: {
            v1: import("./ibcstaking/v1/query.rpc.query").QueryClientImpl;
        };
        mint: {
            v1: import("./mint/v1/query.rpc.query").QueryClientImpl;
        };
        oracle: {
            v1: import("./oracle/v1/query.rpc.query").QueryClientImpl;
        };
    };
}>;
